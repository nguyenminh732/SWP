 ...
 * @author Admin
 */
public class OrderByQrController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Table> table = tabledao.getTableById(tbid);
            ...
            request.getRequestDispatcher("orderbyQr.jsp").forward(request, response);
        }
    }
