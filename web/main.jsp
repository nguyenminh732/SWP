    ...
    <body>
        ...
        <header id="header" class="fixed-top d-flex align-items-cente">
            <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
                ...
                <h1 class="logo me-auto me-lg-0"><a href="main">Restaurantly</a></h1>
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <li><a class="nav-link scrollto" href="/booktable">Book</a></li>
                        <li class="dropdown"><a href="#"><span>Quản Lý</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                <li><a href="#">Drop Down 1</a></li>
                                <li class="dropdown"><a href="#"><span>Deep Drop Down</span> <i class="bi bi-chevron-right"></i></a>
                                    <ul>
                                        <li><a href="/bookingmanager">Quản Lý Đặt Bàn</a></li>
            ...
            <section id="chefs" class="chefs">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <c:forEach items="${listchef}" var="chef">
                        <div class="col-lg-4 col-md-6">
                            <div class="member" data-aos="zoom-in" data-aos-delay="300">
                                <img src="${chef.chefImg}" class="img-fluid" alt="">
                                <div class="member-info">
                                    <div class="member-info-content">
                                        <h4><a href="/SWP391_FASTFOOD/chefinfo?cid=${chef.chefId}">    ${chef.chefName}</a></h4>
                                    ...
                                    <div class="social">
                                        ...
                                        <a href="${chef.linkin}"><i class="bi bi-linkedin"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
